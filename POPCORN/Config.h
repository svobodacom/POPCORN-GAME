#pragma once
#include <Windows.h>
#define _USE_MATH_DEFINES // для подключения константы числа Пи: M_PI
#include "math.h"
...
public:
    ...
    // делаем объекты статическими, чтобы не обращаться к ним через указатель
    // так как это пользовательский тип данных, мы не можем их здесь инициализировать
    // инициализировать их нужно вне класса в cpp-файле
    ...
    static const int Platform_Y_Pos = 175;
